...
var officeId= getUrlParam(location.href, "officeId");
...
(function(mui, window, document, undefined) {
	...
	ui.newPlaceholder = function() {
		...
		fileInput.setAttribute('accept', 'http://192.168.1.142:8082/image/*');
    ...
    type:'post',
    url:url,
    data:{officeId:officeId,invitatiConontent:question,invitationAge:input_num,invitationSex:radio1,invitationPic:dataUrl},
    jsonp: "jsonpCallback",
   async: false,
   dataType: "json",
...
var url='http://47.94.144.116/medicalPortal/inv/postiongs'
function getUrlParam(url, name) {
			var pattern = new RegExp("[?&]" + name + "\=([^&]+)", "g");
			var matcher = pattern.exec(url);
			var items = null;
